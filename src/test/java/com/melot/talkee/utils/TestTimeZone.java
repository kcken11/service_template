...
//        System.out.println("The time Asia/Shanghai is " + nowDateTime);//程序本地运行所在时区为[Asia/Shanhai]
//        //显示世界每个时区当前的实际时间
//        for (int i = 0; i < ids.length; i++) {
...
//
//    @Test
//    public void testEnTime() {
//
//        DateFormat df1 = new SimpleDateFormat("mm:dd 'on' MMM-dd'th'",Locale.ENGLISH);
